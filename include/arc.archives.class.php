    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "上一篇：<a disabled=\"true\" href='$mlink'>{$preRow['title']}</a> ";
            ...
            else
            {
                ...
                $this->PreNext['pre'] = "上一篇：<a disabled=\"true\">没有了</a> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "下一篇：<a disabled=\"true\" href='$mlink'>{$nextRow['title']}</a> ";
            ...
            else
            {
                ...
                $this->PreNext['next'] = "下一篇：<a disabled=\"true\">没有了</a> ";
